...
- Summarize the namespace, ingress hosts, widget dependencies, and any external service links after the next validated review.

## Known Good State
- Describe the last healthy rollout and the checks that proved it.

## Recurring Problems
- Capture repeated failures, broken widgets, config-rendering issues, and stale links.
...
- Note external APIs, DNS, ingress, and Kubernetes Secrets this app depends on.
